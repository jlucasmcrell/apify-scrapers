...
1. **Phoenix HVAC Contractor Leads:** [`datasets/phoenix_hvac_leads/`](datasets/phoenix_hvac_leads/) | [Hugging Face Hub](https://huggingface.co/datasets/joeygambino/phoenix-hvac-contractor-leads) — 10 verified HVAC contractor profiles with ratings, addresses, and phone numbers ([Google Maps Business Leads](https://apify.com/captainhandsome/google-maps-business-search)).
2. **California Licensed Contractors:** [`datasets/california_solar_contractors/`](datasets/california_solar_contractors/) | [Hugging Face Hub](https://huggingface.co/datasets/joeygambino/california-licensed-contractors) — 50 active C-46 and B licensed solar installers with state verification numbers ([California Contractor License Search](https://apify.com/captainhandsome/ca-contractor-license-search)).
3. **Austin Software Engineer Postings:** [`datasets/austin_software_jobs/`](datasets/austin_software_jobs/) | [Hugging Face Hub](https://huggingface.co/datasets/joeygambino/austin-software-engineer-jobs) — 30 normalized job listings with estimated posting dates and salary ranges ([LinkedIn Public Jobs](https://apify.com/captainhandsome/linkedin-public-jobs-search)).
4. **S&P 500 Corporate Filings:** [`datasets/sp500_sec_edgar_filings/`](datasets/sp500_sec_edgar_filings/) | [Hugging Face Hub](https://huggingface.co/datasets/joeygambino/sp500-sec-edgar-filings) — 5 SEC EDGAR filing records with CIK, ticker, SIC and document links ([SEC EDGAR Filings](https://apify.com/captainhandsome/sec-edgar-filings-search)).
5. **US Federal Defense & AI Awards:** [`datasets/us_federal_defense_ai_awards/`](datasets/us_federal_defense_ai_awards/) | [Hugging Face Hub](https://huggingface.co/datasets/joeygambino/us-federal-defense-ai-awards) — 10 federal contract awards with recipient, agency, obligation amount and dates ([USAspending Federal Awards](https://apify.com/captainhandsome/usaspending-federal-awards)).
6. **US Remote AI & ML Job Postings:** [`datasets/us_remote_ai_ml_job_postings/`](datasets/us_remote_ai_ml_job_postings/) | [Hugging Face Hub](https://huggingface.co/datasets/joeygambino/us-remote-ai-ml-job-postings) — 10 remote AI/ML postings with title, company, location and apply URL ([LinkedIn Public Jobs](https://apify.com/captainhandsome/linkedin-public-jobs-search)).
7. **Top Twitch Live Streams:** [`datasets/twitch_top_live_streams_metadata/`](datasets/twitch_top_live_streams_metadata/) | [Hugging Face Hub](https://huggingface.co/datasets/joeygambino/twitch-top-live-streams-metadata) — 10 live-channel records with viewer counts, category and language ([Twitch Live Streams](https://apify.com/captainhandsome/twitch-live-streams-scraper)).
8. **Mobile App Sentiment Reviews:** [`datasets/mobile_apps_user_sentiment_reviews/`](datasets/mobile_apps_user_sentiment_reviews/) | [Hugging Face Hub](https://huggingface.co/datasets/joeygambino/mobile-apps-user-sentiment-reviews) — 10 Google Play reviews with score, thumbs-up count and reviewer metadata ([Google Play Reviews](https://apify.com/captainhandsome/google-play-reviews-scraper)).
